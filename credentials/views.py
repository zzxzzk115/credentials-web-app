    ...
    if request.method == 'GET':
        ...
        try:
            ...
            if model.is_valid():
                ...
                # Send Email
                print('Sending Part1...')
                res1 = send_mail('CI-R51: PDF Transcript Notification Part1 - ' + saved_model.credential_id, 
                    None, 
                    None,
                    [saved_model.user_email_address], 
                    html_message=template_helper.get_rendered_html_native(open('credentials/email_templates/part1.html').read(),
                            { 
